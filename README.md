...
![Database Schema Design](images/schema.png)
...
* Request
  * Method: GET
  * URL: /spots?page=:pageNum&size=:size&minLat=:minLat&maxLat=:maxLat ,etc
  * Query Parameters
